...
hostname='redis-18472.c322.us-east-1-2.ec2.redns.redis-cloud.com'
portnumber=18472
...
# print(r.ping()) 
st.text("Redis connection status: " + str(r.ping()))
...
def ml_search_algorithm(dataframe,feature_column,test_vector,
    ...
    print(f"Person Name: {person_name}, Role: {person_role}, Cosine Similarity: {data_filter['cosine'].max() if not data_filter.empty else 'N/A'}")
    st.text(f"Person Name: {person_name}, Role: {person_role}, Cosine Similarity: {data_filter['cosine'].max() if not data_filter.empty else 'N/A'}")
